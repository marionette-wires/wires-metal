describe('Error', function() {
    ...
    it('should contain the correct properties', function() {
      expect(this.error)
        .to.contain({
          name: 'Bar',
          message: 'Foo',
          url: 'http://github.com/thejameskyle/metal.js#baz'
        });
    });

    it('should output the correct string', function() {
      expect(this.error.toString())
        .to.equal('Bar: Foo See: http://github.com/thejameskyle/metal.js#baz');
    });
  });
  ...
  describe('when passed options with a url', function() {
    ...
    it('should output the correct string', function() {
      expect(this.error.toString())
        .to.equal('Foo: Bar See: http://github.com/thejameskyle/metal.js#baz');
    });
  });
